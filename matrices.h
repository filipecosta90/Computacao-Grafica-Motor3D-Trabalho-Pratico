...
class Matrix4
{
  public:
    ...
    Matrix4&    rotateXCG(float angle);                   // rotate on X-axis with degree
    Matrix4&    rotateYCG(float angle);                   // rotate on Y-axis with degree
    Matrix4&    rotateZCG(float angle);                   // rotate on Z-axis with degree
    Matrix4&    scale(float scale);                     // uniform scale
    Matrix4&    scale(float sx, float sy, float sz);    // scale by (sx, sy, sz) on each axis
    Matrix4&    scaleCG(float x, float y, float z);
