...
const float DEG2RAD = 3.141593 / 180.0;
...
Matrix4& Matrix4::translateCG(float x, float y, float z)
{
  m[12]+=  x;
  m[13]+=  y;
  m[14]+=  z;
...
Matrix4& Matrix4::scaleCG(float x, float y, float z)
{
  m[0] *= x;
  m[5] *= y;
  m[10]*= z;
...
Matrix4& Matrix4::rotateCG(float angle, float x, float y, float z)
{
  rotateXCG(angle);
  rotateYCG(angle);
  rotateZCG(angle);
...
Matrix4& Matrix4::rotateXCG(float angle)
{
  float c = cosf(angle * DEG2RAD);
  float s = sinf(angle * DEG2RAD);
  float m1 = m[1],  m2 = m[2],
...
Matrix4& Matrix4::rotateYCG(float angle)
{
  float c = cosf(angle * DEG2RAD);
  float s = sinf(angle * DEG2RAD);
  float m0 = m[0],  m2 = m[2],
...
Matrix4& Matrix4::rotateZCG(float angle)
{
  float c = cosf(angle * DEG2RAD);
  float s = sinf(angle * DEG2RAD);
  float m0 = m[0],  m1 = m[1],
